...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///usr/src/app/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///usr/src/app/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///usr/src/app/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
...
import { digest, hash as hash$1 } from 'file:///usr/src/app/node_modules/ohash/dist/index.mjs';
...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///usr/src/app/node_modules/@unhead/vue/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///usr/src/app/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///usr/src/app/node_modules/@unhead/vue/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/usr/src/app/0.0.0.0/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/usr/src/app/0.0.0.0","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/usr/src/app/0.0.0.0/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47usr_47src_47app_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/usr/src/app/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/usr/src/app/0.0.0.0/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/usr/src/app/0.0.0.0/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/usr/src/app/0.0.0.0/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/usr/src/app/0.0.0.0/.data/kv"}));
...
const rootDir = "/usr/src/app/0.0.0.0";
